...
- **[OAuth Authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization)** for endpoint security (**[📄](../explanations/security-model.md)**)
