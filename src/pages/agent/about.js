...
export default function AgentAboutView() {
  const {siteConfig} = useDocusaurusContext();
  const [content, setContent] = useState('');
  const [loading, setLoading] = useState(true);
  const mdUrl = `${siteConfig.url}/about.md`;
  ...
  return (
    <Layout title="About — Agent View" description="Machine-readable reShapr about page.">
      <div className={styles.root}>
        <AgentSidebar activeHref="/agent/about" />
        <div className={styles.main}>
          <div className={styles.toolbar}>
            <span className={styles.path}>→ /about.md</span>
      ...
      <Link to="/about" className={styles.viewToggle}>
