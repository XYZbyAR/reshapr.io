...
export default function AgentCommunityView() {
  const {siteConfig} = useDocusaurusContext();
  const [content, setContent] = useState('');
  const [loading, setLoading] = useState(true);
  const mdUrl = `${siteConfig.url}/community.md`;
  ...
  return (
    <Layout title="Community — Agent View" description="Machine-readable reShapr community page.">
      <div className={styles.root}>
        <AgentSidebar activeHref="/agent/community" />
        <div className={styles.main}>
          <div className={styles.toolbar}>
            <span className={styles.path}>→ /community.md</span>
      ...
      <Link to="/community" className={styles.viewToggle}>
